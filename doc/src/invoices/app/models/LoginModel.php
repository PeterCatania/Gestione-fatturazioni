...
class LoginModel
{
  ...
  {
    // query
    $selectUserByUsernameAndPassword = 'select id,username,email,enabled from user where username = :username and password = :password';
  ...
  {
    // query
    $selectAllUsers = 'select id,username,email from administrator where username = :username and password = :password';
