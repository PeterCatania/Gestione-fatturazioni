...
abstract class City implements ActiveRecordInterface
{
     ...
     * @var ObjectCollection|ChildClient[]
     */
    ...
    /**
     * Set the value of [nap] column.
     *
     * @param int $v new value
     * @return $this|\City The current object (for fluent API support)
     */
    public function setNap($v)
    {
        if ($v !== null) {
            $v = (int) $v;
        }
        ...
        if ($this->nap !== $v) {
            $this->nap = $v;
            $this->modifiedColumns[CityTableMap::COL_NAP] = true;
        }
    ...
    public function hydrate($row, $startcol = 0, $rehydrate = false, $indexType = TableMap::TYPE_NUM)
    {
        try {
            ...
            $col = $row[TableMap::TYPE_NUM == $indexType ? 2 + $startcol : CityTableMap::translateFieldName('Nap', TableMap::TYPE_PHPNAME, $indexType)];
            $this->nap = (null !== $col) ? (int) $col : null;
            $this->resetModified();
    ...
    protected function doInsert(ConnectionInterface $con)
    {
        ...
        if ($this->isColumnModified(CityTableMap::COL_NAP)) {
            $modifiedColumns[':p' . $index++]  = 'nap';
        }
            ...
            foreach ($modifiedColumns as $identifier => $columnName) {
                switch ($columnName) {
                    ...
                    case 'name':
                        ...
                        break;
                    case 'nap':
                        $stmt->bindValue($identifier, $this->nap, PDO::PARAM_INT);
                        break;
                }
            }
            $stmt->execute();
    ...
    public function buildCriteria()
    {
        ...
        if ($this->isColumnModified(CityTableMap::COL_NAP)) {
            $criteria->add(CityTableMap::COL_NAP, $this->nap);
        }
    ...
    public function initClients($overrideExisting = true)
    {
        ...
        $collectionClassName = ClientTableMap::getTableMap()->getCollectionClassName();
     ...
     * @return ObjectCollection|ChildClient[] List of ChildClient objects
     * @throws PropelException
     */
    public function getClients(Criteria $criteria = null, ConnectionInterface $con = null)
    {
        ...
        if (null === $this->collClients || null !== $criteria  || $partial) {
            if ($this->isNew() && null === $this->collClients) {
                ...
                $collClients = ChildClientQuery::create(null, $criteria)
                    ->filterByCity($this)
                    ->find($con);
    ...
    /**
     * Sets a collection of ChildClient objects related by a one-to-many relationship
    ...
    {
        /** @var ChildClient[] $clientsToDelete */
    ...
    public function countClients(Criteria $criteria = null, $distinct = false, ConnectionInterface $con = null)
    {
        ...
        if (null === $this->collClients || null !== $criteria || $partial) {
            ...
            $query = ChildClientQuery::create(null, $criteria);
            if ($distinct) {
                $query->distinct();
            }
    ...
    /**
     * @param ChildClient $client The ChildClient object to add.
     */
    protected function doAddClient(ChildClient $client)
    {
    ...
    /**
     * @param  ChildClient $client The ChildClient object to remove.
     * @return $this|ChildCity The current object (for fluent API support)
     */
    public function removeClient(ChildClient $client)
    {
