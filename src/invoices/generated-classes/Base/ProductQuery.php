 ...
 *
 * @method     ChildProductQuery leftJoinInserted($relationAlias = null) Adds a LEFT JOIN clause to the query using the Inserted relation
 * @method     ChildProductQuery rightJoinInserted($relationAlias = null) Adds a RIGHT JOIN clause to the query using the Inserted relation
 * @method     ChildProductQuery innerJoinInserted($relationAlias = null) Adds a INNER JOIN clause to the query using the Inserted relation
 *
 * @method     ChildProductQuery joinWithInserted($joinType = Criteria::INNER_JOIN) Adds a join clause and with to the query using the Inserted relation
 *
 * @method     ChildProductQuery leftJoinWithInserted() Adds a LEFT JOIN clause and with to the query using the Inserted relation
 * @method     ChildProductQuery rightJoinWithInserted() Adds a RIGHT JOIN clause and with to the query using the Inserted relation
 * @method     ChildProductQuery innerJoinWithInserted() Adds a INNER JOIN clause and with to the query using the Inserted relation
 *
 * @method     \InsertedQuery endUse() Finalizes a secondary criteria and merges it with its primary Criteria
 *
...
abstract class ProductQuery extends ModelCriteria
{
     ...
     */
    public function __construct($dbName = 'invoices', $modelName = '\\Product', $modelAlias = null)
    {
    ...
    {
        $sql = 'SELECT id, description, price FROM product WHERE id = :p0';
        try {
    ...
    public function filterByInserted($inserted, $comparison = null)
    {
        if ($inserted instanceof \Inserted) {
            return $this
                ->addUsingAlias(ProductTableMap::COL_ID, $inserted->getProductId(), $comparison);
