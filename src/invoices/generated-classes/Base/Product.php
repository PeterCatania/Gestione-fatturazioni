...
abstract class Product implements ActiveRecordInterface
{
    ...
    public function hydrate($row, $startcol = 0, $rehydrate = false, $indexType = TableMap::TYPE_NUM)
    {
        try {
            ...
            $col = $row[TableMap::TYPE_NUM == $indexType ? 1 + $startcol : ProductTableMap::translateFieldName('Description', TableMap::TYPE_PHPNAME, $indexType)];
    ...
    public function setInserteds(Collection $inserteds, ConnectionInterface $con = null)
    {
        ...
        foreach ($insertedsToDelete as $insertedRemoved) {
            $insertedRemoved->setProduct(null);
        }
     ...
     * @return ObjectCollection|ChildInserted[] List of ChildInserted objects
     */
    public function getInsertedsJoinInvoice(Criteria $criteria = null, ConnectionInterface $con = null, $joinBehavior = Criteria::LEFT_JOIN)
    {
        $query = ChildInsertedQuery::create(null, $criteria);
