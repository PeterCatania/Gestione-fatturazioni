 ...
 * @method     ChildAdministratorQuery orderByEmail($order = Criteria::ASC) Order by the email column
 *
 ...
 * @method     ChildAdministratorQuery groupByEmail() Group by the email column
 *
 ...
 * @method     ChildAdministrator findOneByEmail(string $email) Return the first ChildAdministrator filtered by the email column *
 ...
 * @method     ChildAdministrator requireOneByEmail(string $email) Return the first ChildAdministrator filtered by the email column and throws \Propel\Runtime\Exception\EntityNotFoundException when not found
 *
 ...
 * @method     ChildAdministrator[]|ObjectCollection findByEmail(string $email) Return ChildAdministrator objects filtered by the email column
...
abstract class AdministratorQuery extends ModelCriteria
{
     ...
     */
    public function __construct($dbName = 'invoices', $modelName = '\\Administrator', $modelAlias = null)
    {
    ...
    {
        $sql = 'SELECT id, username, password, email FROM administrator WHERE id = :p0';
        try {
    ...
    public function filterByEmail($email = null, $comparison = null)
    {
        ...
        return $this->addUsingAlias(AdministratorTableMap::COL_EMAIL, $email, $comparison);
    }
