...
abstract class Company implements ActiveRecordInterface
{
    ...
    /**
     * The value for the logo_path field.
     *
     * @var        string
     */
    protected $logo_path;
    ...
    /**
     * Get the [logo_path] column value.
     *
     * @return string
     */
    ...
    /**
     * Set the value of [logo_path] column.
     *
     * @param string $v new value
     * @return $this|\Company The current object (for fluent API support)
     */
    public function setLogoPath($v)
    {
        ...
        if ($this->logo_path !== $v) {
            $this->logo_path = $v;
            $this->modifiedColumns[CompanyTableMap::COL_LOGO_PATH] = true;
        }
    ...
    public function setHouseNo($v)
    {
        ...
        if ($this->house_no !== $v) {
            $this->house_no = $v;
            $this->modifiedColumns[CompanyTableMap::COL_HOUSE_NO] = true;
        }
    ...
    public function setSite($v)
    {
        ...
        if ($this->site !== $v) {
            $this->site = $v;
            $this->modifiedColumns[CompanyTableMap::COL_SITE] = true;
        }
    ...
    public function setTelefone($v)
    {
        ...
        if ($this->telefone !== $v) {
            $this->telefone = $v;
            $this->modifiedColumns[CompanyTableMap::COL_TELEFONE] = true;
        }
    ...
    public function setCityId($v)
    {
        ...
        if ($this->city_id !== $v) {
            $this->city_id = $v;
            $this->modifiedColumns[CompanyTableMap::COL_CITY_ID] = true;
        }
    ...
    public function hydrate($row, $startcol = 0, $rehydrate = false, $indexType = TableMap::TYPE_NUM)
    {
        try {
            ...
            $col = $row[TableMap::TYPE_NUM == $indexType ? 2 + $startcol : CompanyTableMap::translateFieldName('LogoPath', TableMap::TYPE_PHPNAME, $indexType)];
            $this->logo_path = (null !== $col) ? (string) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 3 + $startcol : CompanyTableMap::translateFieldName('Iban', TableMap::TYPE_PHPNAME, $indexType)];
            $this->iban = (null !== $col) ? (string) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 4 + $startcol : CompanyTableMap::translateFieldName('Street', TableMap::TYPE_PHPNAME, $indexType)];
            $this->street = (null !== $col) ? (string) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 5 + $startcol : CompanyTableMap::translateFieldName('HouseNo', TableMap::TYPE_PHPNAME, $indexType)];
            $this->house_no = (null !== $col) ? (string) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 6 + $startcol : CompanyTableMap::translateFieldName('Email', TableMap::TYPE_PHPNAME, $indexType)];
            $this->email = (null !== $col) ? (string) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 7 + $startcol : CompanyTableMap::translateFieldName('Site', TableMap::TYPE_PHPNAME, $indexType)];
            $this->site = (null !== $col) ? (string) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 8 + $startcol : CompanyTableMap::translateFieldName('Telefone', TableMap::TYPE_PHPNAME, $indexType)];
            $this->telefone = (null !== $col) ? (string) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 9 + $startcol : CompanyTableMap::translateFieldName('CityId', TableMap::TYPE_PHPNAME, $indexType)];
            ...
            return $startcol + 10; // 10 = CompanyTableMap::NUM_HYDRATE_COLUMNS.
    ...
    protected function doInsert(ConnectionInterface $con)
    {
        ...
        if ($this->isColumnModified(CompanyTableMap::COL_LOGO_PATH)) {
            $modifiedColumns[':p' . $index++]  = 'logo_path';
        }
        ...
        if ($this->isColumnModified(CompanyTableMap::COL_HOUSE_NO)) {
            $modifiedColumns[':p' . $index++]  = 'house_no';
        }
        if ($this->isColumnModified(CompanyTableMap::COL_EMAIL)) {
            $modifiedColumns[':p' . $index++]  = 'email';
        }
        if ($this->isColumnModified(CompanyTableMap::COL_SITE)) {
            $modifiedColumns[':p' . $index++]  = 'site';
        }
        if ($this->isColumnModified(CompanyTableMap::COL_TELEFONE)) {
            $modifiedColumns[':p' . $index++]  = 'telefone';
        }
        if ($this->isColumnModified(CompanyTableMap::COL_CITY_ID)) {
            ...
            foreach ($modifiedColumns as $identifier => $columnName) {
                switch ($columnName) {
                    ...
                    case 'name':
                        ...
                        break;
                    case 'logo_path':
                        $stmt->bindValue($identifier, $this->logo_path, PDO::PARAM_STR);
                        break;
                    case 'iban':
    ...
    public function toArray($keyType = TableMap::TYPE_PHPNAME, $includeLazyLoadColumns = true, $alreadyDumpedObjects = array(), $includeForeignObjects = false)
    {
        ...
        $result = array(
            $keys[0] => $this->getId(),
            $keys[1] => $this->getName(),
            $keys[2] => $this->getLogoPath(),
            $keys[3] => $this->getIban(),
            $keys[4] => $this->getStreet(),
            $keys[5] => $this->getHouseNo(),
            $keys[6] => $this->getEmail(),
            $keys[7] => $this->getSite(),
            $keys[8] => $this->getTelefone(),
            $keys[9] => $this->getCityId(),
        );
    ...
    public function fromArray($arr, $keyType = TableMap::TYPE_PHPNAME)
    {
        ...
        if (array_key_exists($keys[2], $arr)) {
            $this->setLogoPath($arr[$keys[2]]);
        }
        if (array_key_exists($keys[3], $arr)) {
            $this->setIban($arr[$keys[3]]);
        }
        if (array_key_exists($keys[4], $arr)) {
            $this->setStreet($arr[$keys[4]]);
        }
        if (array_key_exists($keys[5], $arr)) {
            $this->setHouseNo($arr[$keys[5]]);
        }
    ...
    public function buildCriteria()
    {
        ...
        if ($this->isColumnModified(CompanyTableMap::COL_LOGO_PATH)) {
            $criteria->add(CompanyTableMap::COL_LOGO_PATH, $this->logo_path);
        }
        if ($this->isColumnModified(CompanyTableMap::COL_IBAN)) {
            $criteria->add(CompanyTableMap::COL_IBAN, $this->iban);
        }
        if ($this->isColumnModified(CompanyTableMap::COL_STREET)) {
            $criteria->add(CompanyTableMap::COL_STREET, $this->street);
        }
        if ($this->isColumnModified(CompanyTableMap::COL_HOUSE_NO)) {
            $criteria->add(CompanyTableMap::COL_HOUSE_NO, $this->house_no);
        }
        if ($this->isColumnModified(CompanyTableMap::COL_EMAIL)) {
            $criteria->add(CompanyTableMap::COL_EMAIL, $this->email);
        }
        if ($this->isColumnModified(CompanyTableMap::COL_SITE)) {
            $criteria->add(CompanyTableMap::COL_SITE, $this->site);
        }
        if ($this->isColumnModified(CompanyTableMap::COL_TELEFONE)) {
            $criteria->add(CompanyTableMap::COL_TELEFONE, $this->telefone);
        }
        if ($this->isColumnModified(CompanyTableMap::COL_CITY_ID)) {
            $criteria->add(CompanyTableMap::COL_CITY_ID, $this->city_id);
        }
    ...
    public function copyInto($copyObj, $deepCopy = false, $makeNew = true)
    {
        ...
        $copyObj->setLogoPath($this->getLogoPath());
