 ...
 */
abstract class Typology implements ActiveRecordInterface
{
    /**
     * TableMap class name
     */
    const TABLE_MAP = '\\Map\\TypologyTableMap';
    ...
    /**
     * Initializes internal state of Base\Typology object.
     */
    ...
    /**
     * Compares this with another <code>Typology</code> instance.  If
     * <code>obj</code> is an instance of <code>Typology</code>, delegates to
     * <code>equals(Typology)</code>.  Otherwise, returns <code>false</code>.
     *
     ...
     *
     * @return $this|Typology The current object, for fluid interface
     */
     ...
     * @return $this|\Typology The current object (for fluent API support)
     */
    public function setId($v)
    {
        ...
        if ($this->id !== $v) {
            $this->id = $v;
            $this->modifiedColumns[TypologyTableMap::COL_ID] = true;
        }
    ...
    public function setName($v)
    {
        ...
        if ($this->name !== $v) {
            $this->name = $v;
            $this->modifiedColumns[TypologyTableMap::COL_NAME] = true;
        }
    ...
    public function hydrate($row, $startcol = 0, $rehydrate = false, $indexType = TableMap::TYPE_NUM)
    {
        try {
            ...
            $col = $row[TableMap::TYPE_NUM == $indexType ? 0 + $startcol : TypologyTableMap::translateFieldName('Id', TableMap::TYPE_PHPNAME, $indexType)];
            $this->id = (null !== $col) ? (int) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 1 + $startcol : TypologyTableMap::translateFieldName('Name', TableMap::TYPE_PHPNAME, $indexType)];
            ...
            return $startcol + 2; // 2 = TypologyTableMap::NUM_HYDRATE_COLUMNS.

        } catch (Exception $e) {
            throw new PropelException(sprintf('Error populating %s object', '\\Typology'), 0, $e);
        }
    }
    ...
    public function reload($deep = false, ConnectionInterface $con = null)
    {
        ...
        $dataFetcher = ChildTypologyQuery::create(null, $this->buildPkeyCriteria())->setFormatter(ModelCriteria::FORMAT_STATEMENT)->find($con);
     ...
     * @return void
     * @throws PropelException
     * @see Typology::setDeleted()
     * @see Typology::isDeleted()
     */
    public function delete(ConnectionInterface $con = null)
    {
        ...
        $con->transaction(function () use ($con) {
            $deleteQuery = ChildTypologyQuery::create()
    ...
    public function save(ConnectionInterface $con = null)
    {
        ...
        return $con->transaction(function () use ($con) {
            ...
            if ($ret) {
                ...
                $this->postSave($con);
                TypologyTableMap::addInstanceToPool($this);
            } else {
                $affectedRows = 0;
            }
    ...
    protected function doInsert(ConnectionInterface $con)
    {
        ...
        if ($this->isColumnModified(TypologyTableMap::COL_ID)) {
            $modifiedColumns[':p' . $index++]  = 'id';
        }
        if ($this->isColumnModified(TypologyTableMap::COL_NAME)) {
            $modifiedColumns[':p' . $index++]  = 'name';
        }

        $sql = sprintf(
            'INSERT INTO typology (%s) VALUES (%s)',
    ...
    {
        $pos = TypologyTableMap::translateFieldName($name, $type, TableMap::TYPE_NUM);
    ...
    public function toArray($keyType = TableMap::TYPE_PHPNAME, $includeLazyLoadColumns = true, $alreadyDumpedObjects = array(), $includeForeignObjects = false)
    {
        ...
        if (isset($alreadyDumpedObjects['Typology'][$this->hashCode()])) {
            return '*RECURSION*';
        }
        $alreadyDumpedObjects['Typology'][$this->hashCode()] = true;
        $keys = TypologyTableMap::getFieldNames($keyType);
        $result = array(
            $keys[0] => $this->getId(),
            $keys[1] => $this->getName(),
        );
    ...
    public function buildCriteria()
    {
        ...
        if ($this->isColumnModified(TypologyTableMap::COL_ID)) {
            $criteria->add(TypologyTableMap::COL_ID, $this->id);
        }
        if ($this->isColumnModified(TypologyTableMap::COL_NAME)) {
            $criteria->add(TypologyTableMap::COL_NAME, $this->name);
        }
    ...
    {
        $criteria = ChildTypologyQuery::create();
        $criteria->add(TypologyTableMap::COL_ID, $this->id);
     ...
     * If this ChildTypology is new, it will return
     ...
     * @param      ConnectionInterface $con Optional connection object
     * @return $this|ChildTypology The current object (for fluent API support)
     */
    public function setInvoices(Collection $invoices, ConnectionInterface $con = null)
    {
        ...
        foreach ($invoicesToDelete as $invoiceRemoved) {
            $invoiceRemoved->setTypology(null);
        }
     ...
     * @return ObjectCollection|ChildInvoice[] List of ChildInvoice objects
     */
    public function getInvoicesJoinClient(Criteria $criteria = null, ConnectionInterface $con = null, $joinBehavior = Criteria::LEFT_JOIN)
    {
        $query = ChildInvoiceQuery::create(null, $criteria);
    ...
    {
        return (string) $this->exportTo(TypologyTableMap::DEFAULT_STRING_FORMAT);
    }
