...
class ProductTableMap extends TableMap
{
    ...
    protected static $fieldNames = array (
        self::TYPE_PHPNAME       => array('Id', 'Description', 'Price', ),
        self::TYPE_CAMELNAME     => array('id', 'description', 'price', ),
        self::TYPE_COLNAME       => array(ProductTableMap::COL_ID, ProductTableMap::COL_DESCRIPTION, ProductTableMap::COL_PRICE, ),
        self::TYPE_FIELDNAME     => array('id', 'description', 'price', ),
    ...
    protected static $fieldKeys = array (
        self::TYPE_PHPNAME       => array('Id' => 0, 'Description' => 1, 'Price' => 2, ),
        self::TYPE_CAMELNAME     => array('id' => 0, 'description' => 1, 'price' => 2, ),
        self::TYPE_COLNAME       => array(ProductTableMap::COL_ID => 0, ProductTableMap::COL_DESCRIPTION => 1, ProductTableMap::COL_PRICE => 2, ),
        self::TYPE_FIELDNAME     => array('id' => 0, 'description' => 1, 'price' => 2, ),
        self::TYPE_NUM           => array(0, 1, 2, )
    );
