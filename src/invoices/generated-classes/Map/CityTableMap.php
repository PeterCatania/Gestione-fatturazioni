...
class CityTableMap extends TableMap
{
    ...
    /**
     * the column name for the nap field
     */
    const COL_NAP = 'city.nap';
    ...
    protected static $fieldNames = array (
        self::TYPE_PHPNAME       => array('Id', 'Name', 'Nap', ),
        self::TYPE_CAMELNAME     => array('id', 'name', 'nap', ),
        self::TYPE_COLNAME       => array(CityTableMap::COL_ID, CityTableMap::COL_NAME, CityTableMap::COL_NAP, ),
        self::TYPE_FIELDNAME     => array('id', 'name', 'nap', ),
    ...
    protected static $fieldKeys = array (
        self::TYPE_PHPNAME       => array('Id' => 0, 'Name' => 1, 'Nap' => 2, ),
        self::TYPE_CAMELNAME     => array('id' => 0, 'name' => 1, 'nap' => 2, ),
        self::TYPE_COLNAME       => array(CityTableMap::COL_ID => 0, CityTableMap::COL_NAME => 1, CityTableMap::COL_NAP => 2, ),
        self::TYPE_FIELDNAME     => array('id' => 0, 'name' => 1, 'nap' => 2, ),
        self::TYPE_NUM           => array(0, 1, 2, )
    );
    ...
    public function initialize()
    {
        ...
        $this->addColumn('nap', 'Nap', 'INTEGER', true, null, null);
    } // initialize()
    ...
    {
        $this->addRelation('Client', '\\Client', RelationMap::ONE_TO_MANY, array (
  0 =>
  array (
    0 => ':city_id',
    1 => ':id',
  ),
), null, null, 'Clients', false);
  ...
  array (
    ...
    public static function addSelectColumns(Criteria $criteria, $alias = null)
    {
        if (null === $alias) {
            ...
            $criteria->addSelectColumn(CityTableMap::COL_NAP);
        } else {
            $criteria->addSelectColumn($alias . '.id');
            $criteria->addSelectColumn($alias . '.name');
            $criteria->addSelectColumn($alias . '.nap');
        }
    }
     ...
     */
     public static function doDelete($values, ConnectionInterface $con = null)
     {
        ...
        if ($values instanceof Criteria) {
            ...
            $criteria->add(CityTableMap::COL_ID, (array) $values, Criteria::IN);
        }
    ...
    public static function doInsert($criteria, ConnectionInterface $con = null)
    {
        ...
        if ($criteria->containsKey(CityTableMap::COL_ID) && $criteria->keyContainsValue(CityTableMap::COL_ID) ) {
